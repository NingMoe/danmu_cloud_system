...
public class JavaClientController {
    ...
    public RestResultModel latelyParty(String addressId){
        ...
        DanmuAddress danmuAddress = rpcDanmuAddressService.findById(addressId);
        ...
        if( danmuAddress.getType() == 0){
            ...
            partyResourceResultList1 = rpcPartyResourceResultService.findLatelyParty();
            partyResourceResultList2 = rpcPartyResourceResultService.findLatelyPartyByAddressIdAndType(addressId,0);
    ...
    public RestResultModel findTimerDanmuFile(String addressId){
        ...
        restResultModel.setResult(200);
        restResultModel.setData(rpcTimerDanmuService.findTimerDanmuFileList(addressId));
        return restResultModel;
    }
    ...
    public RestResultModel findAdTimerDanmu(String addressId){
        ...
        restResultModel.setResult(200);
        restResultModel.setData(rpcAdTimerService.findTimerDanmuFileList(addressId));
        return restResultModel;
    }
    ...
    public RestResultModel projectorStart(@PathVariable("code") String code){
        ...
        DanmuClient danmuClient = rpcDanmuClientService.findByRegistCode(code);
        if(danmuClient==null){
        ...
        PageResultModel<ProjectorAction> projectorActions =  rpcProjectorService.findProjectorActionPage(code,0,1);
    ...
    public RestResultModel projectorClose(@PathVariable("code") String code){
        ...
        Date nowDate = new Date();
        Projector projector = rpcProjectorService.findByRegisterCode(code);
